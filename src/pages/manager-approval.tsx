...
export default function ManagerApprovalPage() {
  ...
  const details = Object.entries(application || {}).filter(([key, value]) => !hiddenFields.has(key) && !highlightedKeys.has(key) && isUseful(value) && !['managerApprovalRequired', 'status'].includes(key));
